...
【漫画页生成提示词】
生成一张竖版古风漫画页，采用不规则分镜布局，共四个分镜。画面必须是一张完整漫画页，而不是单幅插画。四个分镜大小不同，构图有节奏感，使用白色不规则分割线与少量破格构图。每个分镜只表现一个关键瞬间，连起来能看懂剧情推进。

页面内必须加入少量清晰可读的中文漫画文字，共 2–4 处即可，包括对白气泡、旁白框、拟声词或情绪短句。文字必须简短有力，每处不超过 8–12 个汉字，放在画面留白处或分镜边缘，不遮挡角色面部、手势和关键动作。不要生成大段文字，不要乱码，不要英文，不要无意义符号。

第一格：
描述第一个画面。
本格文字：如有必要，写一句简短对白、旁白、拟声词或情绪短句。
...
整体风格：
顶级画质，高分辨率，AAA级游戏CG质感，官方原画级别的精细度。采用高清日韩系古风全彩漫画排版（Comic page），带有不规则的白色分割线框与破格设计。画面色彩干净清透，线条锐利，拒绝任何油画涂抹感。将剧情中的心理、暧昧、压迫、羞恼、紧张感转换成视觉语言：眼神、表情、手势、距离、衣料动态、光影、构图。保持画面克制，不要色情化，不要裸露，不要过度聚焦身体部位。角色默认均为成年人。画面内中文漫画文字必须像正式漫画对白、旁白与拟声字，清楚、短促、可读，并服务于剧情推进。`;
